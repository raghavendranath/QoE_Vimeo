package com.android_workshop.raghav.qoe_vimeo;
...
import com.android_workshop.raghav.qoe_vimeo.com.example.logger.Log;
...
//http://embed.plnkr.co/o2R49j/
        webSettings.setJavaScriptEnabled(true);
        wView.loadUrl("file:///android_asset/vimeo.html");
       /* try {
            final File path = new File(
                    Environment.getExternalStorageDirectory(), "QoE_DailyMotion_Logs");
            if (!path.exists()) {
